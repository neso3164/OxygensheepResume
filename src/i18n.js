...
const dict = {
  'zh-Hant': {
    ...
    work_d_desc: '後臺運作沒呈現在影片的部分如下: 1.除了結合AI與雲端運算能夠記錄行程,額外會在新的一週開始時主動提醒本周預約 2.報價單資料能夠自動做前處理來入庫並自動取代掉舊版本來維持更新查詢功能 3.每日營業相關登記都經過AI前處理+雲端運算處理入庫.作為接下來長期營運資料分析用, 由於是實際落地BOT 部分後臺真實資料恕不能全數呈現',
