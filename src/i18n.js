...
const dict = {
  'zh-Hant': {
    ...
    hobby_read: '閱讀',
    hobby_read_desc: '類型：技術、商業、心理學與傳記。',
    hobby_sport: '運動',
    hobby_sport_desc: '跑步、健身或球類，維持穩定習慣。',
    hobby_travel: '旅行',
    hobby_travel_desc: '走訪城市與咖啡館，觀察文化差異。',
  ...
  en: {
    ...
    hobby_read: 'Reading',
    hobby_read_desc: 'Topics: tech, business, psychology, biography.',
    hobby_sport: 'Sports',
    hobby_sport_desc: 'Running, fitness, or ball games.',
    hobby_travel: 'Travel',
    hobby_travel_desc: 'Cities and cafes; observing cultures.',
